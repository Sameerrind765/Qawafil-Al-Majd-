...
const authT = {
  en: {
    ...
    email: "Email Address",
    password: "Password",
    emailPlaceholder: "admin@qawafil.com",
    passwordPlaceholder: "••••••••",
    signingIn: "Signing in...",
    welcomeBack: "Operations & Coordinator Portal",
    subtextSignIn: "Access the live fleet control & pilgrim reservations desk.",
    brandName: "Qawafil Al Majd Al Misaliya",
    brandSub: "Qawafil Al Majd Al Misaliya - Pilgrim Transport Hub",
  },
  ar: {
    signIn: "تسجيل الدخول",
    ...
    welcomeBack: "منصة إدارة العمليات والتنسيق",
    subtextSignIn: "الولوج إلى لوحة التحكم بحجوزات المعتمرين وأسطول الحافلات.",
    brandName: "قوافل المجد المثالية",
    brandSub: "قوافل المجد المثالية لنقل الحجاج والمعتمرين والزوار",
  }
};
